...
const BrandingCaseStudy = () => {
  ...
  return (
    <main style={{ background: 'var(--background)', minHeight: '100vh', paddingTop: pageWidth < 768 ? '80px' : '120px' }}>
        ...
        <div className="responsive-grid-strategy" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
          {[
            ...
            >
              ...
              <h4 style={{ color: 'var(--text-primary)', fontSize: pageWidth < 768 ? '1.5rem' : '1.8rem', fontWeight: 800, marginBottom: '1rem', fontFamily: "'Outfit', sans-serif" }}>{item.title}</h4>
              <p style={{ color: 'var(--text-secondary)', lineHeight: 1.7, fontSize: pageWidth < 768 ? '1rem' : '1.1rem', fontWeight: 500 }}>{item.desc}</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      {/* ─── BRANDING PROCESS ─── */}
      <section style={{ padding: pageWidth < 768 ? '5rem 1.5rem' : '10rem 2rem', background: 'var(--section-bg)', borderTop: '1px solid var(--border-color)', borderBottom: '1px solid var(--border-color)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: pageWidth < 768 ? '4rem' : '7rem' }}>
            ...
            <h2 style={{ color: 'var(--text-primary)', fontSize: 'clamp(2.2rem, 6vw, 4.5rem)', fontWeight: 900, fontFamily: "'Outfit', sans-serif", marginBottom: '1.2rem', lineHeight: 1 }}>The Branding <span style={{ color: '#ff4d00' }}>Process.</span></h2>
            <p style={{ color: 'var(--text-secondary)', fontSize: pageWidth < 768 ? '1.1rem' : '1.3rem', fontWeight: 500 }}>From discovery to market dominance.</p>
          </div>
          ...
          <div className="process-grid-responsive" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1.5rem' }}>
            {[
              ...
              >
                ...
                <h5 style={{ color: 'var(--text-primary)', fontSize: '1.3rem', fontWeight: 800, marginBottom: '0.8rem', fontFamily: "'Outfit', sans-serif" }}>{p.title}</h5>
                <p style={{ color: 'var(--text-secondary)', lineHeight: 1.6, fontSize: '0.95rem', fontWeight: 500 }}>{p.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={sectionVariants}>
          <div className="concept-grid-responsive" style={{ display: 'grid', gridTemplateColumns: pageWidth < 992 ? '1fr' : 'repeat(auto-fit, minmax(400px, 1fr))', gap: pageWidth < 768 ? '3rem' : '6rem', alignItems: 'start' }}>
            ...
            <div style={{ position: pageWidth < 992 ? 'static' : 'sticky', top: '150px' }}>
              ...
              <p style={{ fontFamily: "'Inter', sans-serif", fontSize: pageWidth < 768 ? '1.1rem' : '1.25rem', color: 'var(--text-secondary)', lineHeight: 1.8, marginBottom: '2rem', fontWeight: 500 }}>
            ...
            <div style={{ display: 'grid', gap: '1rem' }}>
              ...
              {[
                ...
                >
                  ...
                  <div>
                    <h6 style={{ color: 'var(--text-primary)', fontSize: '1rem', fontWeight: 800, marginBottom: '0.3rem', fontFamily: "'Outfit', sans-serif" }}>{item.title}</h6>
                    <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', lineHeight: 1.5, fontWeight: 500 }}>{item.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
      ...
      <section style={{ padding: pageWidth < 768 ? '0 1.5rem 6rem' : '0 2rem 10rem', textAlign: 'center' }}>
        <motion.div 
          ...
          variants={sectionVariants}
          style={{ 
            background: 'linear-gradient(var(--background), var(--background)) padding-box, linear-gradient(135deg, #ff4d00, #cc3d00) border-box', 
        ...
        >
          ...
          <h2 style={{ color: 'var(--text-primary)', fontSize: pageWidth < 768 ? '2.2rem' : '3rem', fontWeight: 900, marginBottom: '1.2rem', fontFamily: "'Outfit', sans-serif", lineHeight: 1.1 }}>Ready to Build <br/>Your Brand?</h2>
          <p style={{ color: 'var(--text-secondary)', fontSize: pageWidth < 768 ? '1rem' : '1.2rem', marginBottom: '2rem', fontWeight: 500 }}>Let's create an identity that lasts.</p>
          <motion.button 
