  ...
  return (
    <main style={{ background: '#02040a', minHeight: '100vh', paddingTop: '80px' }}>
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: 'clamp(4rem, 8vw, 7rem) 2rem 8rem' }}>
        ...
        <h1 style={{ fontFamily: "'Outfit', sans-serif", fontSize: 'clamp(2.5rem, 5vw, 4rem)', fontWeight: 900, color: '#fff', marginBottom: '1rem', letterSpacing: '-0.03em' }}>Privacy Policy</h1>
