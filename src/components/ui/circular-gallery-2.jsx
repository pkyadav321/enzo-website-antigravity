...
class App {
  ...
  createMedias(items, bend, textColor, borderRadius, font) {
    const defaultItems = [
      { image: `https://images.unsplash.com/photo-1517430816045-df4b7de11d1d?q=80&w=800&auto=format&fit=crop`, text: "Visual Core" },
      { image: `https://images.unsplash.com/photo-1550745165-9bc0b252726f?q=80&w=800&auto=format&fit=crop`, text: "Tech Stack" },
      { image: `https://images.unsplash.com/photo-1558655146-d09347e92766?q=80&w=800&auto=format&fit=crop`, text: "Creative Flow" },
    ];
...
const CircularGallery = ({
  ...
  useEffect(() => {
    ...
    const computedColor = computedStyle.color || "white";
